...
public class ServFiche extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		Integer level = Integer.parseInt(request.getParameter("level")) ; //TO DO : v�rifier si entier
		...
		HM.put("Connaissance(Myst�res)", Integer.parseInt(request.getParameter("connaissanceMysteresRank"))) ;
		...
		HM.put("D�cryptage", Integer.parseInt(request.getParameter("decryptageRank"))) ;
		HM.put("D�guisement", Integer.parseInt(request.getParameter("deguisementRank"))) ;
		HM.put("D�placement Silencieux", Integer.parseInt(request.getParameter("deplacementsilencieuxRank"))) ;
		HM.put("D�samor�age/sabotage", Integer.parseInt(request.getParameter("desamorcageRank"))) ;
		HM.put("D�tection", Integer.parseInt(request.getParameter("detectionRank"))) ;
		...
		HM.put("Repr�sentation", Integer.parseInt(request.getParameter("representationsRank"))) ;
		...
		//On cr�er sa fiche et on l'enregistre en base de donn�es
