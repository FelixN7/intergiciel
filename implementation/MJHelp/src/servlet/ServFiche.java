...
public class ServFiche extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		Integer level = Integer.parseInt(request.getParameter("level")) ; //TO DO : vérifier si entier
		...
		HM.put("Connaissance(Mystères)", Integer.parseInt(request.getParameter("connaissanceMysteresRank"))) ;
		...
		HM.put("Décryptage", Integer.parseInt(request.getParameter("decryptageRank"))) ;
		HM.put("Déguisement", Integer.parseInt(request.getParameter("deguisementRank"))) ;
		HM.put("Déplacement Silencieux", Integer.parseInt(request.getParameter("deplacementsilencieuxRank"))) ;
		HM.put("Désamorçage/sabotage", Integer.parseInt(request.getParameter("desamorcageRank"))) ;
		HM.put("Détection", Integer.parseInt(request.getParameter("detectionRank"))) ;
		...
		HM.put("Représentation", Integer.parseInt(request.getParameter("representationsRank"))) ;
